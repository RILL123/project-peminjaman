        ...
        <div class="bg-white rounded-2xl card-shadow overflow-hidden">
            ...
            <div class="bg-linear-to-br from-perpusku1 to-perpusku2 px-8 py-12 text-white relative">
                ...
                <div class="flex flex-col items-center relative z-10">
                    ...
                    <p class="text-perpusku4 text-sm font-light">Buat Akun Baru</p>
                </div>
            </div>
            ...
            <div class="px-8 py-10">
                ...
                <?php if (isset($_GET['success'])): ?>
                    <div class="mb-6 p-4 bg-green-50 border-l-4 border-green-500 rounded-lg">
                        <p class="text-green-700 text-sm font-medium">
                            <span class="font-bold">Sukses!</span> Akun berhasil dibuat. Silakan <a href="login.php" class="font-semibold hover:underline">login di sini</a>
                        </p>
                    </div>
                <?php endif; ?>

                <form class="space-y-5" action="../controller/aksi_register.php" method="POST">
                    <!-- Nama Input -->
                    <div class="relative">
                        <label for="nama" class="block text-perpusku1 font-semibold text-sm mb-2 ml-1">Nama Lengkap</label>
                        <div class="relative">
                            <input 
                                type="text" 
                                id="nama" 
                    ...
                    <div class="relative">
                        <label for="confirm_password" class="block text-perpusku1 font-semibold text-sm mb-2 ml-1">Konfirmasi Password</label>
                        <div class="relative">
                            <input 
                                type="password" 
                                id="confirm_password" 
                ...
                <div class="text-center">
                    <p class="text-sm text-gray-600">Sudah punya akun? <a href="login.php" class="text-perpusku1 font-semibold hover:text-perpusku2 transition">Masuk di sini</a></p>
                </div>
